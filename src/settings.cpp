...
const QString Setting::XDG_CACHE_DIR = env.contains("XDG_CACHE_HOME") ? env.value("XDG_CACHE_HOME") : Util::joinPath(HOME, QStringList() << ".cache");
const QString Setting::XDG_CONFIG_DIR = env.contains("XDG_CONFIG_HOME") ? env.value("XDG_CONFIG_HOME") : Util::joinPath(HOME, QStringList() << ".config");
const QString Setting::CACHE_DIR =  env.contains("WALPP_CACHE_DIR") ? env.value("WALPP_CACHE_DIR") : Util::joinPath(XDG_CACHE_DIR, QStringList() << "walpp");
...
const QString Setting::MODULE_DIR = Util::joinPath(CONF_DIR, QStringList()  << "modules");
