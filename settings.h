...
QString CACHE_DIR = env.contains("PYWAL_CACHE_DIR") ? env.value("PYWAL_CACHE_DIR") : util.joinPath(XDG_CACHE_DIR, QString("wal"));
QString CONF_DIR = util.joinPath(XDG_CONFIG_DIR, QString("wal"));
